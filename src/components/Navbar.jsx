...
const Navbar = () => {
  ...
  return (
    <div className="w-full border-b fixed bg-black py-3 z-10">
      <div className="flex w-5/6 mx-auto items-center justify-between">
        <div className="flex items-center gap-x-6">
          <Image src={Logo} height={100} width={100} alt="logo" />
          <nav className="flex gap-x-6 flex-1">
        ...
        <div className="flex items-center gap-x-3 justify-end">
          <div className="relative">
            <IoSearchOutline
              className="absolute top-1/2 -translate-y-1/2 left-2 opacity-40"
              fontSize="24"
            />
            <input
              type="text"
              placeholder="Search for ecosystem, trending quests etc.."
              className="w-full py-2 pl-10 pr-3 bg-[rgba(255,255,255,0.07)] rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder:opacity-40"
            />
          </div>
          <div className="bg-[rgba(255,255,255,0.07)] p-2 rounded-full">
